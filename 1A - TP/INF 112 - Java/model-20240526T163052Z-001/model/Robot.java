...
public class Robot extends Component {
    ...
    public void addComponentsToVisit(Component component) {
        if (this.componentsToVisit == null) {
            this.componentsToVisit = new ArrayList<Component>();
        }
        this.componentsToVisit.add(component);
    }
    ...
    public void behave() {
        if (componentsToVisit != null && !componentsToVisit.isEmpty()) {
            ...
            if (hasReached(target)) {
                ...
                System.out.println("cible_atteinte");
            }
            moveTowards(target);
        }
    }
